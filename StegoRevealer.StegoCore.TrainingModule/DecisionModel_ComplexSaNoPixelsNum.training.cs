...
{
    public partial class DecisionModel_ComplexSaNoPixelsNum
    {
        public const string RetrainFilePath =  @"E:\Development\StegoRevealer\StegoRevealer\StegoRevealer.StegoCore.TrainingModule\TrainingData\MlAnalysisData_ComplexSaNoPixelsNum.csv";
        ...
        public static IEstimator<ITransformer> BuildPipeline(MLContext mlContext)
        {
            ...
            var pipeline = mlContext.Transforms.ReplaceMissingValues(new []{new InputOutputColumnPair(@"ChiSqrHorizontalRelativeVolume", @"ChiSqrHorizontalRelativeVolume"),new InputOutputColumnPair(@"ChiSqrVerticalRelativeVolume", @"ChiSqrVerticalRelativeVolume"),new InputOutputColumnPair(@"RsRelativeVolume", @"RsRelativeVolume"),new InputOutputColumnPair(@"KzhaHorizontalThreshold", @"KzhaHorizontalThreshold"),new InputOutputColumnPair(@"KzhaHorizontalBitsVolume", @"KzhaHorizontalBitsVolume"),new InputOutputColumnPair(@"KzhaVerticalThreshold", @"KzhaVerticalThreshold"),new InputOutputColumnPair(@"KzhaVerticalBitsVolume", @"KzhaVerticalBitsVolume"),new InputOutputColumnPair(@"Noise", @"Noise"),new InputOutputColumnPair(@"Sharpness", @"Sharpness"),new InputOutputColumnPair(@"Blur", @"Blur"),new InputOutputColumnPair(@"Contrast", @"Contrast"),new InputOutputColumnPair(@"EntropyShennon", @"EntropyShennon"),new InputOutputColumnPair(@"EntropyRenyi11", @"EntropyRenyi11")})      
                                    .Append(mlContext.Transforms.Concatenate(@"Features", new []{@"ChiSqrHorizontalRelativeVolume",@"ChiSqrVerticalRelativeVolume",@"RsRelativeVolume",@"KzhaHorizontalThreshold",@"KzhaHorizontalBitsVolume",@"KzhaVerticalThreshold",@"KzhaVerticalBitsVolume",@"Noise",@"Sharpness",@"Blur",@"Contrast",@"EntropyShennon",@"EntropyRenyi11"}))      
                                    .Append(mlContext.BinaryClassification.Trainers.LightGbm(new LightGbmBinaryTrainer.Options(){NumberOfLeaves=4,NumberOfIterations=370,MinimumExampleCountPerLeaf=20,LearningRate=0.40274869947194003,LabelColumnName=@"IsDataHided",FeatureColumnName=@"Features",Booster=new GradientBooster.Options(){SubsampleFraction=0.9999997766729865,FeatureFraction=0.9755460048810201,L1Regularization=2.188951359696167E-10,L2Regularization=0.9999997766729865},MaximumBinCountPerFeature=359}));
