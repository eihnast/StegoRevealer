...
namespace StegoRevealer_StegoCore_TrainingModule
{
    ...
    {
        public const string RetrainFilePath =  @"E:\Development\StegoRevealer\StegoRevealer\StegoRevealer.StegoCore.TrainingModule\TrainingData\MlAnalysisData_ComplexSaNoQuality.csv";
        ...
        public static IEstimator<ITransformer> BuildPipeline(MLContext mlContext)
        {
            ...
            var pipeline = mlContext.Transforms.ReplaceMissingValues(new []{new InputOutputColumnPair(@"ChiSqrHorizontalRelativeVolume", @"ChiSqrHorizontalRelativeVolume"),new InputOutputColumnPair(@"ChiSqrVerticalRelativeVolume", @"ChiSqrVerticalRelativeVolume"),new InputOutputColumnPair(@"RsRelativeVolume", @"RsRelativeVolume"),new InputOutputColumnPair(@"KzhaHorizontalThreshold", @"KzhaHorizontalThreshold"),new InputOutputColumnPair(@"KzhaHorizontalBitsVolume", @"KzhaHorizontalBitsVolume"),new InputOutputColumnPair(@"KzhaVerticalThreshold", @"KzhaVerticalThreshold"),new InputOutputColumnPair(@"KzhaVerticalBitsVolume", @"KzhaVerticalBitsVolume"),new InputOutputColumnPair(@"PixelsNum", @"PixelsNum")})      
                                    .Append(mlContext.Transforms.Concatenate(@"Features", new []{@"ChiSqrHorizontalRelativeVolume",@"ChiSqrVerticalRelativeVolume",@"RsRelativeVolume",@"KzhaHorizontalThreshold",@"KzhaHorizontalBitsVolume",@"KzhaVerticalThreshold",@"KzhaVerticalBitsVolume",@"PixelsNum"}))      
                                    .Append(mlContext.BinaryClassification.Trainers.FastTree(new FastTreeBinaryTrainer.Options(){NumberOfLeaves=18,MinimumExampleCountPerLeaf=2,NumberOfTrees=634,MaximumBinCountPerFeature=872,FeatureFraction=0.9577854108723004,LearningRate=0.011153395785995644,LabelColumnName=@"IsDataHided",FeatureColumnName=@"Features",DiskTranspose=false}));
