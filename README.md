...
#### Поддерживаемые ОС:
* Windows 10 / Windows 11 (.exe, протестирован в: Windows 11 24H2, Windows 11 25H2)
...
* Переход к временной папке с логами и настройками <img align="right" width="100" src="Docs/TempBtnScreen.png"> можно осуществить через соответствующую кнопку в меню параметров.
