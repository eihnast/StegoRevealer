...
public class NoiseCalculator
{
    ...
    /// Оценка шума
    /// </summary>
    public double CalcNoiseLevel(NoiseCalculationMethod method, bool byChannels = false)
    {
        switch (method)
        {
            case NoiseCalculationMethod.Method1:
                return byChannels ? CalcNoiseLevelMethod1ByChannels() : CalcNoiseLevelMethod1();
            case NoiseCalculationMethod.Method2:
                return byChannels ? CalcNoiseLevelMethod2ByChannels() : CalcNoiseLevelMethod2();
            default:
                return byChannels ? CalcNoiseLevelMethod2ByChannels() : CalcNoiseLevelMethod2();
        }
    }
